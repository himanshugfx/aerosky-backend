    ...
    return (
        <div className="space-y-8 pb-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h1 className="text-3xl lg:text-5xl font-black text-white tracking-tightest">Personnel <span className="text-slate-400 font-medium">Record</span></h1>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-2">
                        {teamMembers.length} REGISTERED OPERATIVES
                    </p>
                </div>
                <button
