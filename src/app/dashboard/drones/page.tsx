...
export default function DronesPage() {
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] animate-slide-up">
            ...
            <p className="mt-8 text-[10px] font-black text-slate-400 uppercase tracking-widest animate-pulse">Syncing Fleet Telemetry</p>
        </div>
    )
        ...
        <div className="space-y-12 animate-slide-up pb-20">
            ...
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-8">
                ...
                <button
                    ...
                    className="btn-premium-primary !py-5 shadow-2xl shadow-blue-500/20 group"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                    { label: 'Active Fleet Size', value: drones.length, icon: Plane, color: 'blue' },
                    ...
                    <div key={i} className="modern-card p-10 group relative overflow-hidden">
                        ...
                        <div className="relative flex items-center gap-8">
                            <div className={`w-16 h-16 rounded-[2rem] border border-${stat.color}-100 flex items-center justify-center bg-${stat.color}-50 text-${stat.color}-600 shadow-sm transition-all duration-500 group-hover:bg-${stat.color}-600 group-hover:text-white`}>
                            ...
                            <div className="flex items-start justify-between mb-10">
                                ...
                                <div className="flex gap-2">
                                    <Link
                                        ...
                                        className="w-11 h-11 bg-white border border-slate-200 text-slate-400 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 rounded-xl flex items-center justify-center transition-all shadow-sm"
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        <span className="text-[10px] font-black text-blue-600 uppercase tracking-widest bg-blue-50 px-2 py-0.5 rounded-md border border-blue-100">UAV Systems</span>
                                        <div className="flex-1 h-[1px] bg-slate-100" />
                                    </div>
                                    <h3 className="text-2xl font-black text-slate-900 tracking-tight group-hover:text-blue-600 transition-colors uppercase">{drone.modelName}</h3>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="p-4 rounded-2xl bg-slate-50/50 border border-slate-100 flex flex-col gap-1">
                                        ...
                                        {drone.webPortalLink ? (
                                            <a href={drone.webPortalLink} target="_blank" rel="noopener noreferrer" className="text-[11px] font-black text-blue-600 hover:text-blue-500 underline flex items-center gap-1">
                                                Live Feed <LinkIcon className="w-2.5 h-2.5" />
                                            </a>
                                        ) : (
                                            <span className="text-[11px] font-black text-slate-300">Offline</span>
                                        )}
                                    </div>
                                </div>
                            </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center z-[110] p-6 animate-in fade-in duration-500">
                    <div className="bg-white rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.5)] w-full max-w-xl overflow-hidden animate-slide-up border border-white/20">
                        <div className="p-12 pb-8 flex items-center justify-between relative overflow-hidden bg-slate-950 text-white">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-blue-600/20 blur-[80px] rounded-full translate-x-32 -translate-y-32" />
                            <div className="relative z-10 space-y-2">
                                ...
                                <p className="text-white/40 text-[10px] font-black uppercase tracking-[0.3em] flex items-center gap-3">
                                    Aircraft Specification Registry <ShieldCheck className="w-4 h-4 text-blue-400" />
                                </p>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-12 space-y-10">
                            ...
                            <div className="bg-blue-50/40 border border-blue-100 p-8 rounded-[2.5rem] flex items-start gap-6 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/5 blur-2xl rounded-full" />
                                <ShieldCheck className="w-8 h-8 text-blue-600 shrink-0 mt-1 relative z-10" />
                                <div className="relative z-10">
                                    <p className="text-sm font-black text-blue-900 mb-2 uppercase tracking-tight">Compliance Authentication</p>
                                    <p className="text-xs font-medium text-blue-700/80 leading-relaxed uppercase tracking-tighter">
                            ...
                            <div className="flex gap-6">
                                ...
                                <button
                                    type="submit"
                                    disabled={submitting}
                                    className="flex-1 btn-premium-primary !py-5 shadow-2xl shadow-blue-500/20"
                                >
                                    {submitting ? (
