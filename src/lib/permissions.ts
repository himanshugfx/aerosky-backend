...
// Stock Management permissions granted to every role
const ALL_INVENTORY_PERMISSIONS: Permission[] = [
    PERMISSIONS.INVENTORY_VIEW,
...
export const ROLE_PERMISSIONS: Record<string, Permission[]> = {
    ...
    ADMINISTRATION: Object.values(PERMISSIONS).filter((p) => p !== PERMISSIONS.SETTINGS_ADMIN),
